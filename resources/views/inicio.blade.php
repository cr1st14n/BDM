...
<body>
    ...
    <div class="br-sideleft overflow-y-auto">
        ...
        <div class="br-sideleft-menu">
            <a href="#" class="br-menu-link" onclick="funcView(1)">
    ...
    <script src="{{ asset('resources/plantilla/lib/jquery/jquery.j') }}s"></script>
    ...
    <script src="{{ asset('resources/js/meet_1.js') }}"></script>
</body>
